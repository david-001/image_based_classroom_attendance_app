...
namespace ECNG_FaceRecognition
{
    public class DatabaseOperations
    {
        ...
        //public void AddFaceToDB(Image InputFace, String FaceID, String FaceName)
        //{
        ...
        //    try
        //    {
        //        //Convert the face image to bytes format for storing in MS Access Database
        //        byte[] FaceAsBytes = ConvertToDBFormat(InputFace, FaceID);
        //        TotalRows++;
        //        // just to check that at what location is the image is being stored to
        //        MessageBox.Show("Adding row # " + TotalRows.ToString());
        //        SqlCommand insert = new SqlCommand("Insert INTO TrainingSet1 (id,FaceID,FaceName,FaceImage) VALUES('" + TotalRows.ToString() + "','" + FaceID + "','" + FaceName + "',@MyImg)", Connection);

        //        //To insert the image in database column as a stream, we have to set parameters for the image field as follows:
        //        SqlParameter imageParameter = insert.Parameters.AddWithValue("@MyImg", SqlDbType.Binary);
        ...
        //public byte[] ConvertToDBFormat(Image InputImage, string InputName)
        //{
        //    //Resize image
        //    Image<Bgr, Byte> tmpimg = new Image<Bgr, byte>(new Bitmap(InputImage));
        //    Image<Bgr, Byte> tmpimg1 = tmpimg.Resize(100, 100, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);

        //    //To store out image to MS Access Database as OLE object
        //    //the image first needs to be converted to binary format
        //    //because OLE object type contains data as binary
        //    //the conversion goes like this:
        //    //Image -> Bitmap -> MemoryStream -> byte[] -> binary

        //    //1. Convert the PictureBox.Image to Bitmap format
        //    Bitmap BmpImage = new Bitmap(tmpimg1.ToBitmap());
        //    //Save picture as a file
        //    BmpImage.Save(InputName + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);

        //    //2. Create an empty memory stream
        //    MemoryStream stream = new MemoryStream();

        //    //3. Convert the Bitmap image "BmpImage" to MemoryStream "stream"
        //    // in a specific format, such as "jpeg", "bmp", etc
        //    BmpImage.Save(stream, System.Drawing.Imaging.ImageFormat.Jpeg);

        //    //4. Convert this bitmap stream to bit array form
        ...
        //public int getEcng7000AttndTotalRows()
        //{
        //    if (Connection.State.Equals(ConnectionState.Closed))
        //        Connection.Open();
        ...
        //    try
        //    {
        //        MySqlCommand getTotalRows = new MySqlCommand("Select Count(*) from ecng7000attendance", Connection);
        //        count = int.Parse(getTotalRows.ExecuteScalar() + "");
        //        return count;
        //    }
